...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      charset: "utf-8",
      htmlAttrs: { lang: "ar-SA", dir: "rtl" }, // Set the language to Arabic and direction to RTL
      viewport: "width=device-width,initial-scale=1",
      title: "Albashra",
      titleTemplate: "%s - Albashra.com",
      meta: [
        { name: "apple-mobile-web-app-title", content: "Albashra" },
        { name: "application-name", content: "Albashra" },
  ...
  robots: {
    rules: {
      ...
      Sitemap: "https://Albashra.com/sitemap.xml",
    },
  },
