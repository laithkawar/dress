<template>
  <main class="container pt-4 mx-auto mb-12 max-w-7xl text-zinc-600 md:pt-10">
    <ArchiveHero />
    ...
    <div class="px-6 lg:px-8">
      <input
        ...
        placeholder="Search"
        type="text"
        class="block w-full bg-[#F1F2F4] dark:bg-slate-900 dark:placeholder-zinc-500 text-zinc-300 rounded-md border-gray-300 dark:border-gray-800 shadow-sm focus:border-rose-300 focus:ring focus:ring-rose-200 focus:ring-opacity-50"
      />
    </div>

    <div class="px-6 my-5 space-y-5 lg:px-8">
